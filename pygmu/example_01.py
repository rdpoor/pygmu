...
def sin_at(at_s, freq_hz, amp):
    ...
    More accurately: Create a Processing Element that, when you call render(),
    produces a sine tone starting at the given # of seconds.

    This function shows that it's easy to compose different PEs together to
    create more complex (or more bespoke) results.
    """
