...
class EnvDetectDbPE(PygPE):
    """
    Simple envelope detector.
    """

    def __init__(self, src_pe, attack=0.9, release=0.1):
    ...
    def render(self, requested:Extent):
        ...
        if overlap.is_empty():
            return ut.const_frames(ut.DB_MIN, requested.duration(), self.channel_count())
