...
pg.Transport().play(pg.WavReaderPE("../samples/14_yeah_f.wav"))
pg.Transport().play(mogrify("../samples/14_yeah_f.wav"))

pg.Transport().play(pg.WavReaderPE("../samples/03_Fox.wav"))
pg.Transport().play(mogrify("../samples/03_Fox.wav"))
