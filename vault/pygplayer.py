...
This owes much to https://github.com/spatialaudio/python-sounddevice
...
class RecGui(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title('PygPlayer')

        padding = 10

        f = ttk.Frame()

        self.play_button = ttk.Button(f)
        self.play_button.pack(side='left', padx=padding, pady=padding)
    ...
    def on_play(self):
        ...
        self.play_button['command'] = self.on_stop
    ...
    def init_buttons(self):
        ...
        self.play_button['command'] = self.on_play
        if self.stream:
            self.play_button['state'] = 'normal'
