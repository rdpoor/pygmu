...
class Sport(object):
    """
    Sport is an experimental alternative to Transport
    """
        ...
        def callback(outdata, n_frames, time, status):
            ...
            if show_meter:
                if self._use_ansi and meter_type == 'live':
                    ...
                    # take the rms of the most recent set of frames and print a single char to the term representing the loudness of this recent moment
    ...
    def term_play(self,meter_type='live', max_silent_frames=300,  max_dur_secs_for_infinite_sources=100):
        ...
        while True:
            ...
            ret = Sport(out).play(meter_type, max_silent_frames, True)
            match ret:
                case ' ':
