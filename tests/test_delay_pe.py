...
from pygmu import (ArrayPE, ConstPE, DelayPE, Extent, IdentityPE, LinearRampPE, PygPE, SpatialAPE)
...
class TestDelayPE(unittest.TestCase):
    ...
    def test_init(self):
        ...
        delay = 0
        src = SpatialAPE(LinearRampPE(0, 10, extent), 0, curve='none').crop(extent)
        pe = DelayPE(src, delay)
        self.assertIsInstance(pe, DelayPE)
