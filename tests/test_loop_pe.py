...
class TestLoopPE(unittest.TestCase):
    ...
    def test_render1(self):
        ...
        pe = LoopPE(src_pe, loop_length=5) # Extent spans negative to positive
        e = Extent(-6, 6)
        ...
        pe = LoopPE(src_pe, loop_length=5) # src < loop_len, negative to positive
        e = Extent(-5, 7)
        ...
        pe = LoopPE(src_pe, loop_length=5) # source starts > 0
        e = Extent(0, 12)
    ...
    def test_extent(self):
        ...
        src_pe = CropPE(IdentityPE(channel_count=1), Extent(3, 6))
        pe = LoopPE(src_pe, loop_length=5)
