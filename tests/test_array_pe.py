...
class TestArrayPE(unittest.TestCase):
    ...
    def test_extent(self):
        self.assertTrue(Extent(0, self.frames.shape[1]).equals(self.pe.extent()))

    def test_frame_rate(self):
        self.assertEqual(self.pe.frame_rate(), PygPE.DEFAULT_FRAME_RATE)

    def test_channel_count(self):
        self.assertEqual(self.pe.channel_count(), self.frames.shape[0])
