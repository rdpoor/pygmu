...
intro = pg.MixPE(  # beats 0-24
    ...
    pg.SpatialAPE(combify(motif12), dtor(-90)).delay(beats(16)), # 16 - 24
)

v1 = pg.MixPE(  # beats 24-48
    beat_loop.crop(pg.Extent(0, beats(16))).gain(0.25),
    combify(bass).gain(0.8),
    pg.SpatialAPE(combify(motif), dtor(90)),
...
v2 = pg.MixPE(  # beats 48-64
    ...
    pg.SpatialAPE(combify(motif), dtor(45)),
    pg.SpatialAPE(combify(motif), dtor(-45)).delay(beats(8)),
)
...
v3 = pg.MixPE(  # beats 64-80
    ...
    combify(bass).gain(0.8),
    biquadify(bass_m12).gain(0.0625),
    pg.SpatialAPE(combify(motif19), dtor(-90), gain_r=0),
    combify(motif).gain(0.7),
    pg.SpatialAPE(combify(motif12), dtor(90), gain_l=0).gain(0.7).delay(beats(0.25)),
