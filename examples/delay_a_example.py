...
warped = pg.DelayAPE(source, pg.SinPE(frequency=1, amplitude=100.0, frame_rate=FRAME_RATE))
# DelayAPE with a time-varying delay has infinite extent.  Crop it to the length of the original
